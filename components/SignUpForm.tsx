        ...
        <div>
          ...
          <div className="relative">
            <input
              type="text"
              required
              className="appearance-none block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50 focus:bg-white placeholder-slate-400 focus:outline-none focus:border-[#1E88E5] focus:ring-4 focus:ring-[#1E88E5]/10 transition-all text-slate-900 shadow-sm"
